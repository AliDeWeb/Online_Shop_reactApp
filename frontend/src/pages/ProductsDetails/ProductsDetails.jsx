              ...
              <div className="bg-gray-100 p-4 rounded-xl lg:w-[600px] 2xl:w-auto">
                <div className="flex items-center gap-x-4 gap-y-2 flex-wrap">
                  ...
                  <button className="flex items-center gap-1 font-dana py-1.5 px-2 rounded-xl bg bg-gray-200 transition-all hover:bg-gray-300">
                    <span className="size-[20px] rounded-full bg-yellow-500"></span>
                    زرد
                  </button>
                  <button className="flex items-center gap-1 font-dana py-1.5 px-2 rounded-xl bg bg-gray-200 transition-all hover:bg-gray-300">
                    <span className="size-[20px] rounded-full bg-blue-700"></span>
                    آبی
                  </button>
                  <button className="flex items-center gap-1 font-dana py-1.5 px-2 rounded-xl bg bg-gray-200 transition-all hover:bg-gray-300">
                    <span className="size-[20px] rounded-full bg-red-500"></span>
                    قرمز
                  </button>
                  <button className="flex items-center gap-1 font-dana py-1.5 px-2 rounded-xl bg bg-gray-200 transition-all hover:bg-gray-300">
                    <span className="size-[20px] rounded-full bg-teal-700"></span>
                    سبز
                  </button>
                  <button className="flex items-center gap-1 font-dana py-1.5 px-2 rounded-xl bg bg-gray-200 transition-all hover:bg-gray-300">
                    <span className="size-[20px] rounded-full bg-amber-500"></span>
                    طلایی
                  </button>
                </div>
                <div className="mt-4">
                ...
                <div className="mt-4">
                  <div className="font-dana flex items-center justify-between mt-8 w-full">
                    <span className="font-danaBold text-teal-600 text-center text-xl sm:text-2xl flex items-center justify-center w-full">
